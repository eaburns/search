...
static void scroll(const Geom2d::Point&, const Geom2d::Point&);
...
static void scroll(const Geom2d::Point &l0, const Geom2d::Point &l1) {
	Geom2d::Point delta(l1.x - l0.x, l1.y - l0.y);
